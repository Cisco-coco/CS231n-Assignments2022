...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        stretched_dim = (num_filters * H * W) // 4
        W2 = np.random.normal(loc=0.0, scale=weight_scale, size=(stretched_dim, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        caches = [conv_relu_pool_cache, affine_relu_cache, affine_cache]
        ...
        affine_dout, dW3, db3 = affine_backward(dout, affine_cache)
        affine_relu_dout, dW2, db2 = affine_relu_backward(affine_dout, affine_relu_cache)
        conv_relu_pool_dout, dW1, db1 = conv_relu_pool_backward(affine_relu_dout, conv_relu_pool_cache)
